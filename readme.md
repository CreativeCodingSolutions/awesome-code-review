...
- [PR Quality Analyzer](https://creativecodingsolutions.github.io/pr-quality-analyzer/) - Free web tool to analyze any public GitHub pull request. Paste a PR URL and get an A-F score with detailed metrics on description quality, labels, size, and engagement. No sign-up needed.
